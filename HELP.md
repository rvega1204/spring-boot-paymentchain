...
java -jar C:\Users\User\Documents\cursos\microservices\paymentchainparent\businessdomain\customer\target\customer-0.0.1-SNAPSHOT.jar --spring.cloud.config.name=config-client --spring.cloud.config.profile=local
```
